...
# v5.130: MACD+RSI 信号权重激进提升 (1.5x → 1.8x)
# 理由: 回测数据显示MACD+RSI最优(TOP1: 17.1% 收益, 2.35 Sharpe, 60% 胜率, 4.08% 回撤)
MACD_RSI_SIGNAL_BOOST = 1.8  # v5.130: +20% TOP1策略  # v5.130: 1.5 → 1.8 (+20% 额外权重) 回测驱动激进
...
TECH_GROWTH_WEIGHT_BOOST = 0.40  # v5.130: +33% 科技成长  # v5.130: 0.30 → 0.40 (+33%) MACD+RSI科技成长最优策略
...
KELLY_MAX_POSITION = 0.065  # v5.130: +35% 单仓6.5%  # v5.130: 4.8% → 6.5% (+35%) 基于Sharpe2.35激进
KELLY_WIN_RATE_BOOST = 0.10    # 胜率每高5%，仓位+2% (保持)
KELLY_COEFFICIENT = 1.65  # v5.130: +3.1% 激进模式  # v5.130: 1.60 → 1.65 (+3.1%) 回测驱动激进模式
